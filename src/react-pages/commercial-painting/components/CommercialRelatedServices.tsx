...
const related = [
  {
    ...
    desc: "Walls, ceilings, trim, and doors. Sherwin-Williams Duration paint proven in Hawaii's humidity. Free color consultation included.",
    slug: "interior-painting",
  },
  {
    icon: "ri-building-line",
    title: "Exterior Painting",
    desc: "Salt air, UV rays, trade winds — Oahu's climate is tough on exterior paint. After 30+ years on Oahu, I know which products hold up.",
...
export default function CommercialRelatedServices() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 text-base mt-4 max-w-xl mx-auto">
            Hawaii Painters 808 handles more than just commercial properties. Here's everything else we do across Oʻahu.
          </p>
        </div>
