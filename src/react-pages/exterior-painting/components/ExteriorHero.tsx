      ...
      <div className="relative w-full px-6 md:px-16 pb-20 pt-40">
        <div className="max-w-3xl">
          ...
          <h1 className="text-white font-black italic text-5xl md:text-6xl lg:text-7xl leading-tight mb-6 uppercase">
            ...
            <span className="text-[#4a9fa5]">Built to Last</span><br />
            In Hawaii
          </h1>
          <p className="text-white/80 text-lg leading-relaxed mb-10 max-w-2xl">
            Hawaii Painters 808 uses Sherwin-Williams Duration — a premium paint proven in Oʻahu's climate over 30+ years. Cheap paint on a Hawaii exterior is money wasted in two years. We do it right the first time.
          </p>
