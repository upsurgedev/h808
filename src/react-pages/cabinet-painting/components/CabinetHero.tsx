  ...
  return (
    <section className="relative min-h-[92vh] flex items-end overflow-hidden bg-[#1a1a1a]">
      <div className="absolute inset-0">
        <img
          src="/images/cabinet-painting-hero.jpg"
          alt="Cabinet painting Oahu Hawaii — Hawaii Painters 808"
      ...
      <div className="relative w-full px-6 md:px-16 pb-20 pt-40">
        <div className="max-w-3xl">
          ...
          <h1 className="text-white font-black italic text-5xl md:text-6xl lg:text-7xl leading-tight mb-6 uppercase">
            Cabinet Painting<br /><span className="text-[#4a9fa5]">Brand New Look.</span><br />Fraction of the Cost.
          </h1>
          <p className="text-white/80 text-lg leading-relaxed mb-10 max-w-2xl">
            New cabinets in Hawaii cost $10,000–$30,000+. Hawaii Painters 808 delivers a flawless, factory-finish cabinet paint job for a fraction of that — kitchen, bathroom, laundry, or any room on Oʻahu.
          </p>
          ...
          <div className="flex flex-wrap gap-8">
            {[
              ...
              { value: "300+", label: "Cabinets Painted" },
