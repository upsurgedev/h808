...
export default function DrywallHero() {
  return (
    <section className="relative min-h-[92vh] flex items-end overflow-hidden bg-[#1a1a1a]">
      <div className="absolute inset-0">
        <img
          src="/images/hero-drywall.jpg"
          alt="Drywall repair Oahu Hawaii — Hawaii Painters 808"
      ...
      <div className="relative w-full px-6 md:px-16 pb-20 pt-40">
        <div className="max-w-3xl">
          ...
          <h1 className="text-white font-black italic text-5xl md:text-6xl lg:text-7xl leading-tight mb-6 uppercase">
            Drywall Repair<br /><span className="text-[#4a9fa5]">Fixed Right.</span><br />Before We Paint.
          </h1>
          <p className="text-white/80 text-lg leading-relaxed mb-10 max-w-2xl">
            Holes, cracks, water damage, popcorn ceiling removal — Hawaii Painters 808 fixes it all before a single drop of paint goes on. Proper prep is what separates a 2-year paint job from a 10-year one.
          </p>
