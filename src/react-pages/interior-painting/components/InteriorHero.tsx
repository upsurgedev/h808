  ...
  return (
    <section className="relative min-h-[92vh] flex items-end overflow-hidden bg-[#1a1a1a]">
      <div className="absolute inset-0">
        <img
          src="/images/interior-painting-hero.jpg"
          alt="Interior painting Oahu Hawaii — Hawaii Painters 808"
      ...
      <div className="relative w-full px-6 md:px-16 pb-20 pt-40">
        <div className="max-w-3xl">
          ...
          <h1 className="text-white font-black italic text-5xl md:text-6xl lg:text-7xl leading-tight mb-6 uppercase">
            ...
            <span className="text-[#4a9fa5]">That Transforms</span><br />
            Your Home
          </h1>

          <p className="text-white/80 text-lg leading-relaxed mb-10 max-w-2xl">
            Hawaii Painters 808 delivers expert interior painting across all of Oʻahu. Sherwin-Williams Duration paint, proper prep, two coats minimum — from someone who's been painting Hawaii homes for 30+ years.
          </p>
