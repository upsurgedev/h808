...
export default function InteriorCta() {
  return (
    <AreaContactSection
      ...
      sourcePage="interior-painting"
      description="Get a free, no-obligation estimate from Hawaii Painters 808. Our team will visit your home personally, assess every room, and have a detailed quote to you within 24 hours."
      trustItems={[
