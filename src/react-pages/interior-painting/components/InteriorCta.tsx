  ...
  return (
    <section className="relative py-24 px-6 md:px-16 overflow-hidden bg-[#1a1a1a]">
      <div className="absolute inset-0">
        <img
          src="/images/interior-cta.jpg"
          alt="Interior painting result — Hawaii Painters 808"
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-white font-black italic text-4xl md:text-5xl lg:text-6xl uppercase leading-tight mb-6">
          ...
          <span className="text-[#4a9fa5]">Your Interior?</span>
        </h2>

        <p className="text-white/70 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
          Get your free, no-obligation estimate from Hawaii Painters 808 today. Lopaka will visit your home personally, assess every room, and have a detailed quote to you within 24 hours.
        </p>
