...
export default function ResidentialLocations() {
  return (
    <section className="bg-white py-10 px-6 md:px-16 border-t border-gray-100">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start sm:items-center gap-4 flex-wrap">
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <span className="text-[#1a1a1a] font-black text-sm uppercase tracking-wider whitespace-nowrap">
        ...
        <div className="flex flex-wrap gap-2">
          {primaryAreas.map((area) => (
            <a
              ...
              className="text-gray-500 hover:text-[#4a9fa5] text-sm font-semibold transition-colors whitespace-nowrap cursor-pointer"
            >
              {area.name}
            </a>
          ))}
