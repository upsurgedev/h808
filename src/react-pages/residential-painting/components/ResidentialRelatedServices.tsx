...
export default function ResidentialRelatedServices() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 text-base mt-4 max-w-xl mx-auto">
            Hawaii Painters 808 handles more than just residential homes. Here's everything else we do across Oʻahu.
          </p>
        </div>
