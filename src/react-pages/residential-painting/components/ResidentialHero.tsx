      ...
      <div className="relative w-full px-6 md:px-16 pb-20 pt-40">
        <div className="max-w-3xl">
          ...
          <h1 className="text-white font-black italic text-5xl md:text-6xl lg:text-7xl leading-tight mb-6 uppercase">
            Residential Painting<br /><span className="text-[#4a9fa5]">For Your</span><br />ʻOhana's Home
          </h1>
          <p className="text-white/80 text-lg leading-relaxed mb-10 max-w-2xl">
            Hawaii Painters 808 handles full home painting across all of Oʻahu — interior, exterior, or both. Your home is where your ʻohana lives. We treat it that way. Clean, respectful, on schedule.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <a href="/contact" className="flex items-center justify-center gap-2 bg-[#4a9fa5] hover:bg-[#3d8a8f] text-white font-black text-sm tracking-wider px-8 py-4 rounded-full transition-all cursor-pointer whitespace-nowrap">
              <i className="ri-file-list-3-line"></i>GET FREE ESTIMATE
            </a>
            <a href="tel:+18082723816" className="flex items-center justify-center gap-2 bg-white/10 border-2 border-white hover:bg-white hover:text-[#1a1a1a] text-white font-black text-sm tracking-wider px-8 py-4 rounded-full transition-all cursor-pointer whitespace-nowrap">
              <i className="ri-phone-fill"></i>(808) 272-3816
            </a>
          </div>
          <div className="flex flex-wrap gap-8">
            {[{ value: "30+", label: "Years Experience" }, { value: "500+", label: "Homes Painted" }, { value: "5★", label: "Average Rating" }, { value: "1yr", label: "Workmanship Warranty" }].map((stat) => (
              <div key={stat.label}>
